...
console.log("Is candy healthy? " + candyIsHealthy)
...
let answerBigInt = BigInt(Number.MAX_VALUE) + 9007199254740995n;
console.log(answerBigInt);
...
answerBigInt = "Reassigned a string value"
console.log(answerBigInt)
...
let typeOfVariable = 27;
console.log(typeof (typeOfVariable));

typeOfVariable = "assigned";
console.log(typeof(typeOfVariable));
