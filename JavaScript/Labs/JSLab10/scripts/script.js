...
// if (input === "y") {
//     console.log("My favorite cookies is chocolate chip.");
// } else {
//     console.log("It was nice knowing you.");
// }
...
// if (display == Number(display)) {
//     console.log("Nice Job!")
// } else {
//     console.log("Need to be better at following instructions.")
// }
...
// */
let arr = ["apples", "strawberries"];
icecream = prompt("Do you like icecream? " + "y for yes" + " and " +"n for no");
sprinkle = prompt("Do you want sprinkles?" + "y for yes" + " and " + "n for no");

if (icecream == 'y') {
    if (sprinkle  == 'y') {
        arr.push("icecream", "sprinkles");
        console.log(arr)
    } else if (sprinkle == 'n') {
        arr.push("icecream");
        console.log(arr);
...
// if (array == "y") {
//     array = prompt("Do you want to add Sprinkle? " + "y for yes")
//     if (array == "y") {
